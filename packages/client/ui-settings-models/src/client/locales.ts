...
export const en = {
  ...
  welcomeBody: 'Agent Hub for OPC 0.1 remains in testing for early developers. Many areas need further improvement, and we welcome feedback from the developer community. Its core plugins and foundational APIs will continue to evolve rapidly over the coming months.\n\nWe look forward to exploring the limits of intelligence with developers around the world, building on open-source, open, reusable, and composable infrastructure. We welcome developers everywhere to join the plugin ecosystem.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  creating: '创建中\u2026',
  welcomeTitle: '内测声明',
  welcomeBody: 'Agent Hub for OPC 目前的 0.1 版本仍处在面向早期开发者进行测试的阶段，还有许多地方需要持续改进和打磨，希望听取广大开发者的反馈建议。预计其核心插件以及基础 API 都会在接下来的一段时间内快速迭代、持续演化。\n\n我们期待与全球开发者一起，在开源、开放、可复用、可组合的基础设施之上，共同探索智能上限。欢迎全球开发者加入插件生态。',
  welcomeContinue: '继续',

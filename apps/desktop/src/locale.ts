...
export const en = {
  ...
  startupFailed: 'Agent Hub for OPC could not start',
  startupLoading: 'Starting Agent Hub for OPC…',
...
export const zh = {
  application: '应用',
  startupFailed: 'Agent Hub for OPC 无法启动',
  startupLoading: '正在启动 Agent Hub for OPC…',
  ...
  updateTitle: 'Agent Hub for OPC 更新',
  ...
  pluginWindowTitle: 'Agent Hub for OPC — 桌面插件',
